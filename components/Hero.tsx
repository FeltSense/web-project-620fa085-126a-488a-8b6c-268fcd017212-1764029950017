      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            Build Faster with TechFlow
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Modern Development Platform</span>
          </h1>
          
          {/* Subtitle */}
          <p className="text-xl md:text-2xl text-gray-400 mb-8 leading-relaxed max-w-2xl mx-auto">
            Accelerate your workflow with cutting-edge tools designed for developers who demand speed, security, and scalability.
          </p>
